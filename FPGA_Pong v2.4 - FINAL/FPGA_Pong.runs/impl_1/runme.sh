...
HD_PWD='C:/Users/lukem/Desktop/FPGA_Pong v2.4 - FINAL/FPGA_Pong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_Pong.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_Pong.tcl -notrace
