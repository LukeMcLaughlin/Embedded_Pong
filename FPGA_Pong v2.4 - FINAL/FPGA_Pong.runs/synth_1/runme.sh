...
HD_PWD='C:/Users/lukem/Desktop/FPGA_Pong v2.4 - FINAL/FPGA_Pong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_Pong.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_Pong.tcl
